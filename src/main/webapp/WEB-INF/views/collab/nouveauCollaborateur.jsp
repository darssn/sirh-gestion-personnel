...
<body>
    ...
    <main class="container-fluid ">
     ...
     <!--   <a class="btn btn-primary" href="creer_errors.html" role="button">Afficher les erreurs formulaire</a> -->
        ...
        <form method="post" action="nouveau" style="margin-top:50px" class="offset-xl-1">
            ...
            <div class="row mb-2 mt-2">
                ...
                <div class="col-12 col-xl-6">
                    <textarea id="adresse" name="adresse" rows="3" class="form-control"></textarea>
                </div>
            ...
            <div class="row mb-2 mt-2">
                ...
                <div class="col-12 col-xl-6">
                    <input type="text" id="numSS" name="numSS" class="form-control">
                </div>
            </div>
            ...
            <div class="row" style="margin-top:20px;margin-bottom:50px;">
                <div class="col offset-8">
                    <button class="btn btn-primary" type="button" data-toggle="modal" data-target="#formModal">Créer</button>
                </div>
            </div>
